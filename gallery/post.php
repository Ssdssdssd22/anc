...
<body style="font-family: 'Ubuntu' , sans-serif;">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
		<a class="navbar-brand font-weight-bolder mr-3 " href="index.html"><img width="50px" height="50px"
				src="https://i.ibb.co/McKPCc6/anclogo.png"></a>
		...
		<div class="collapse navbar-collapse" id="navbarsDefault">
			<ul class="navbar-nav mr-auto align-items-center">
				<form class="bd-search hidden-sm-down">
					<Button class="btn btn-danger rounded" onclick="goBack();">Go Back</Button>
				</form>
			</ul>
						...
						<article class="card">
							...
							<div class="card-body">
								<h1 class="card-title display-4">
									Sushi Rolls </h1>
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat fugit modi fuga
									obcaecati atque, ducimus veniam, est voluptatum aut, iste ipsam eaque ad blanditiis.
									Cumque ducimus labore dolorem omnis eos!
									Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nobis assumenda laudantium
									velit magni, alias repellendus mollitia labore, asperiores nulla, quo blanditiis
									aspernatur accusantium. Laboriosam minima maxime ipsa, corrupti eaque accusamus.
								</p>
								<hr>
								<div class="socials-media">
									...
									<ul class="list-unstyled">
										...
										<li class="d-inline-block ml-1 mr-1"><a href="#" class="text-dark">#ANCPhotographyClub</a></li>
									</ul>
								</div>
								<small class="d-block"><a class="btn btn-sm btn-gray200" href="invoaniar"><i
